...
function Get-ComponentCode
{
       ...
       (
        ...
        [ValidateSet("2.0","2.1","2.2","2.3","2.4","2.5","2.6","2.7","2.8","2.9","3.0","3.0.3","3.1","3.2","3.3","3.4","3.4.1","3.5","3.6","10.4","10.4.1","10.5","10.5.1","10.6","10.6.1","10.7","10.7.1","10.8","10.8.1","10.8.2","10.9","10.9.1","2018.0","2018.1","2019.0","2019.1","2019.2","2020.0","2020.1","2020.2","2020.3","2021.0","2022.0","2021.1","2021.1.1","2021.2.1", "2021.2", "2021.3.1", "2021.3","2022.1","2022.1.1","2022.2","2022.3","2023.0","2023.1","2023.2","2023.3","2024.0","2024.1","2024.2","2025.0","2025.1","11.0","11.1","11.2","11.3","11.4","11.5","12.0")]
        [parameter(Mandatory = $true)]
        [System.String]
        $Version
    )
...
function Invoke-DataStoreConfigureBackupLocationTool
{
    ...
    $op = $p.StandardOutput.ReadToEnd()
    if($p.ExitCode -eq 0) {                    
        Write-Verbose "Backup location tool executed successfully."
