...
$CacheLocation = "$env:ProgramData\Microsoft\Windows\PowerShell\Configuration\BuiltinProvCache\ArcGIS_xWindowsUpdate"
...
function Set-TargetResource
{
    ...
    if($Ensure -eq 'Present')
    {
        ...
        Start-Process -FilePath 'wusa.exe' -ArgumentList "`"$filepath`" /quiet /log:`"$Log`"" -Wait -NoNewWindow -ErrorAction SilentlyContinue
