...
function Get-ComponentCode
{
       ...
       param
       (
        [ValidateSet("Server","Portal","DataStore","GeoEvent","NotebookServer","MissionServer","WorkflowManagerServer","Monitor","WebStyles", "WebAdaptor","Desktop","Pro","LicenseManager","NotebookServerSamplesData")]
        [parameter(Mandatory = $true)]
        [System.String]
        $ComponentName,

        [ValidateSet("2.0","2.1","2.2","2.3","2.4","2.5","2.6","2.7","10.4","10.4.1","10.5","10.5.1","10.6","10.6.1","10.7","10.7.1","10.8","10.8.1","10.9","2018.0","2018.1","2019.0","2019.1","2019.2","2020.0","2020.1")]
        [parameter(Mandatory = $true)]
        [System.String]
        $Version
    )
    ...
    $ProductCodes = @{
        ...
        Monitor = @{
            ...
            '10.9' = '95616516-785C-4B2A-81F3-869FB6F44031'
        }
        Desktop = @{
...
function Get-DataStoreBackupLocation
{
    ...
    if($UseDescibeDatastore){
        ...
        if($locationsString.StartsWith("Backups locations for $($TypeString) data store:")){
...
function Invoke-DataStoreConfigureBackupLocationTool
{
    ...
    $DataStoreTypeAsString = if($DataStoreType -ieq "Relational"){ "relational" }elseif($DataStoreType -ieq "TileCache"){ "tileCache" }else{ "spatiotemporal" }
...
Export-ModuleMember -Function Invoke-ArcGISWebRequest, ConvertTo-HttpBody, Invoke-UploadFile,`
                                ...
                                Set-ConfiguredHostName, Get-ConfiguredHostIdentifierType, Get-ComponentCode, `
