            ...
            if($RemoteFederation -or $PortalServerFederation){
                if($RemoteFederation){
                    ...
                    if(($AllNodes | Where-Object { ($_.Role -icontains 'PortalWebAdaptor')}  | Measure-Object).Count -gt 0){
                        ...
                        {
                            $SSLCertificate = $PortalWAMachineNode.SslCertificates | Where-Object { $_.Target -icontains 'WebAdaptor' }  | Select-Object -First 1
                        ...
                        if(($AllNodes | Where-Object { ($_.Role -icontains 'LoadBalancer')}  | Measure-Object).Count -gt 0){
                            ...
                            {
                                $SSLCertificate = $LoadbalancerNode.SslCertificates | Where-Object { $_.Target -icontains 'LoadBalancer' }  | Select-Object -First 1
                                $PortalHostName = $SSLCertificate.Alias
                            }
                        }
                        ...
                        {
                            $SSLCertificate = $PrimaryPortalMachineNode.SslCertificates | Where-Object { $_.Target -icontains 'Portal' }  | Select-Object -First 1
                            $PortalHostName = $SSLCertificate.Alias
                        }
                        $PortalPort = 7443
                ...
                if(($AllNodes | Where-Object { ($_.Role -icontains 'ServerWebAdaptor')}  | Measure-Object).Count -gt 0){
                    ...
                    {
                        $SSLCertificate = $PrimaryServerMachineNode.SslCertificates | Where-Object { $_.Target -icontains 'Server' }  | Select-Object -First 1
                        $ServerHostName = $SSLCertificate.Alias
                    }
                    $ServerPort = 6443
